...
var stepIdHandler = function(jsonMessage, replyHandler){
	console.log('stepId jsonMessage'+ JSON.stringify(jsonMessage));
	console.log('user '+ jsonMessage.userId + ' is in step '+jsonMessage.stepId);
}

eb.registerHandler(eventbusPrefix+"services:kvdconnection:stepid", stepIdHandler, function() {
	console.log("stepIdHandler registered in the cluster");
});
